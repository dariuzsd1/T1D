...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from('products')
    .select('product_name, brand, category, common_names, units_per_box, units_per_container, typical_usage_per_day, default_refill_interval_days, in_use_days, gtin, discontinued')
